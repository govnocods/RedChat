...
func (a *App) routes() {
	...
	a.Router.HandleFunc("/api/logout", a.Handlers.LogoutHandler)

	messages := http.HandlerFunc(a.Handlers.GetMessages)
	a.Router.Handle("/api/messages", a.Middlewares.APIAuthMiddleware(messages))
